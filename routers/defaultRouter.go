...
func init() {
	...
	beego.Router("/user/myComment", &itying.UserController{}, "get:UserComment")
	beego.Router("/user/comment", &itying.UserController{}, "get:Comment")
	beego.Router("/user/doComment", &itying.UserController{}, "post:DoComment")
